    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cast', models.ForeignKey(limit_choices_to={'duties__name__icontains': 'Cast'}, on_delete=django.db.models.deletion.CASCADE, related_name='moviecast', to='celebs.Celebrity')),
